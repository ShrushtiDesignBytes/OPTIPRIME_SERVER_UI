    ...
    <div className="p-4">
      <div className="flex-col gap-3">
          ...
          <div className="bg-black rounded-md w-[30%]">
            <div className="pt-5 px-5">
              ...
              <div className="flex justify-between mt-10 items-center">
                <span className="grid">
                  <p className="text-[#C37C5A] text-sm xl:text-base">
                    Running Time
                  </p>
        ...
        <div className="grid grid-cols-2 gap-4 mb-5">
            ...
            <div className="genset-toggle-A fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-[#0A3D38] p-6 rounded-md shadow-lg w-1/3">
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="font-normal text-[#CACCCC] text-base text-center">
                    You can switch off anytime by clicking the power control in
                    dashboard
                  </div>
                </div>
              </div>
          ...
          {showStopDialog_A && (
            <div
              className={`genset-toggle-A fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50`}
            >
              <div className="bg-[#0A3D38] p-6 rounded-md shadow-lg w-1/3">
                <div className="flex justify-end">
                  <button
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  />
                  <div className="w-10 h-10">
                    <img src={StopIcon} alt="Icon" className="w-full h-full" />
                  </div>
                  <div className="font-semibold text-xl text-white">
                    Genset Stopped Succesfully!
                  </div>
              ...
              <div className="relative grid grid-cols-3 gap-4 text-xs xl:text-sm text-[#C37C5A] pb-4">
                <div className="flex items-start">
                  <img
                    src={Gen_Image}
                    alt=""
                    className="w-36 h-24 xl:w-40 xl:h-28"
                  />
                </div>
                ...
                <div className="flex flex-col justify-between">
                  <div className="flex items-center justify-end gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {/* Toggle switch with disabled styling during cooldown or warmup */}
                      <div
                        className={`genset-toggle-A w-14 h-7 rounded-full relative transition-all duration-300 ${
                          isOn_A ? "bg-green-500" : "bg-gray-400"
                        } ${
                          (isInCooldown_A && !isOn_A) ||
                          (isInWarmup_A && isOn_A)
                            ? "opacity-50 cursor-not-allowed"
                      ...
                      >
                        <div
                          className={`w-7 h-7 bg-white rounded-full absolute top-0 transition-all duration-300 ${
                            isOn_A ? "translate-x-7" : "translate-x-0"
                          }`}
                        ></div>
                      </div>
                    </div>
          ...
          {showSuccessDialog_B && (
            <div
              className={`genset-toggle-B fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50`}
            >
              <div className="bg-[#0A3D38] p-6 rounded-md shadow-lg w-1/3">
                <div className="flex justify-end">
                  <button
                ...
                <div className="flex flex-col justify-between">
                  <div className="flex items-end justify-start gap-6">
                    <div className="">
                      ...
                      {/* Toggle switch with disabled styling during cooldown or warmup */}
                      <div
                        className={`toggle-switch-B genset-toggle w-14 h-7 rounded-full relative transition-all duration-300 ${
