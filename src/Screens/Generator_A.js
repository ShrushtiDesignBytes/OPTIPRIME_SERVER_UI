...
const Generator_A = ({ datas, BASEURL, status, setId, fetchStatus }) => {
  const { id } = useParams();
  ...
  useEffect(() => {
    setIsOn(status ? status.genset1Status : false);
  }, [status]);
  */
  ...
  const updateStatusON = async () => {
    ...
    try {
      ...
      const optimisticData = {
        ...
        flag: "AWS", // Changed to "AWS" to distinguish it as server-side
      };
  ...
  const updateStatusOFF = async () => {
    ...
    await fetch(`${BASEURL}/status/${id}`, {
      ...
      body: JSON.stringify({
        genset12Status: status.genset2Status === true ? true : false,
        genset1Status: false,
        //"genset2Status": false,
        flag: "AWS",
      }),
  ...
  const toggleSwitch = async () => {
    ...
    setIsOn((prevIsOn) => {
      ...
      setShowDialog(false);
      newIsOn ? updateStatusON() : updateStatusOFF();
      newIsOn ? setShowSuccessDialog(true) : setShowStopDialog(true);
                ...
                <div className="grid grid-cols-2 m-2 ml-3">
                  <div className="flex flex-col justify-start gap-5">
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="font-medium text-sm">Pune, Baner</p>
                    </div>
                    <div className="flex flex-col gap-1">
                      <p className="text-[#DDDDDD] font-medium text-sm opacity-50">
                        Sys Voltage
                      </p>
                      <p className="font-medium text-sm">50 V</p>
                    </div>
                    <div className="flex flex-col gap-1">
                      <p className="text-[#DDDDDD] font-medium text-sm opacity-50">
                        Cylinder
                ...
                <div className="grid grid-cols-2 m-2 ml-3">
                  <div className="flex flex-col justify-start gap-5">
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="font-medium text-sm">M123A - 2014</p>
                    </div>
                    <div className="flex flex-col gap-1">
                      <p className="text-[#DDDDDD] font-normal text-sm opacity-50">
                        Upcoming Maintanence
                      </p>
                      <p className="font-medium text-sm">12.02.2023</p>
                    </div>
                    <div className="flex flex-col gap-1">
                      <p className="text-[#DDDDDD] font-normal text-sm opacity-50">
                        Intake air method
                  ...
                  <div className="flex flex-col justify-start gap-5">
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="font-medium text-sm">12.02.2020</p>
                    </div>
                    <div className="flex flex-col gap-1">
                      <p className="text-[#DDDDDD] font-normal text-sm opacity-50">
