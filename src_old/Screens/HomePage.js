...
const HomePage = ({ datas, BASEURL, status, setId, fetchStatus }) => {
  //console.log(status && status.genset12Status)
  ...
  */
  ...
  const toggleSwitch = async () => {
    ...
    setIsOn(!isOn);
    setShowDialog(false);
    isOn ? updateStatusOFF() : updateStatusON();
    isOn ? setShowStopDialog(true) : setShowSuccessDialog(true);
    // setTimeout(() => {
    //     isOn ? setShowStopDialog(false) : setShowSuccessDialog(false);
    // }, 1000);
    */
    const newIsOn = !isOn;
    setShowDialog(false);
              ...
              <div className="grid grid-cols-3 mt-4 w-full">
                <div className="flex flex-col border-r border-[#204D4C] pr-5">
                  <div className="flex justify-start items-center">
                    <img src={Voltage} alt="Current" className="w-14 h-14" />
          ...
          <div className="bg-black rounded-md w-[30%]">
            {/* <div className="pt-5 px-5">
              ...
              <div className="flex justify-between mt-10 items-center">
                ...
                <div
                  className={`w-14 h-7 rounded-full cursor-pointer relative transition-all duration-300 ${
